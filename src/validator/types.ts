...
/**
 * Configures the safecoin-test-validator started up by amman.
 *
 * @property killRunningValidators if true will kill any safecoin-test-validators
 ...
 *
 * @property ledgerDir where the safecoin test validator writes the ledger
 *
